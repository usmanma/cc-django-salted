...
class Common(Configuration):
    ...
    DATABASES = values.DatabaseURLValue('postgres://{{ cookiecutter.repo_name }}_user:{{ cookiecutter.repo_name }}_password@localhost/{{cookiecutter.repo_name}}_db')
    ...
    STATIC_ROOT = join(os.path.dirname(BASE_DIR), '_static')
    ...
    MEDIA_ROOT = join(BASE_DIR, '_media')
